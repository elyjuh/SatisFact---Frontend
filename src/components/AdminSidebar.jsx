      ...
      <nav id="sidebar" className={`${isCollapsed ? "close" : ""} ${isMobileOpen ? "show" : ""}`}>
        <ul>
          ...
          <li className={location.pathname === "/admin/report" ? "active" : ""}>
            <NavLink to="/admin/reports" onClick={closeMobileMenu}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="#FFFFFF">
          ...
          {/* Survey */}
          <li className={location.pathname === "/admin/survey" ? "active" : ""}>
            <NavLink to="/admin/survey" onClick={closeMobileMenu}>
          ...
          <li>
            ...
            <ul className={`sub-menu ${isManageOpen ? "show" : ""}`}>
              <div>
                ...
                <li className={location.pathname === "/admin/surveys" ? "active" : ""}><NavLink to="/admin/surveys" onClick={closeMobileMenu}>Surveys</NavLink></li>
              </div>
            </ul>
          </li>
